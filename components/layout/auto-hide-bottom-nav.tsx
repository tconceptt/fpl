...
export function AutoHideBottomNav() {
  ...
  return (
    <nav 
      className={cn(
        "fixed bottom-0 left-0 z-30 w-full border-t border-white/10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 transition-transform duration-300 ease-in-out md:hidden",
