    ...
    return (
        <div className="relative w-full flex items-center justify-center overflow-hidden py-16 sm:py-20 md:py-24">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="hero-orb-1 absolute top-20 left-10 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl" />
                <div className="hero-orb-2 absolute bottom-20 right-10 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl" />
            </div>
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6">
                <div className="max-w-5xl mx-auto">
                    {/* Badge */}
                    {showBadge && (
                        <div className={cn("hero-fade-up hero-fade-up-0", "flex justify-center mb-6 sm:mb-8")}>
                    ...
                    {/* Title */}
                    <div className={cn("hero-fade-up hero-fade-up-1", "text-center mb-6 sm:mb-8")}>
                    ...
                    {/* Subtitle */}
                    {subtitle && (
                        <div className={cn("hero-fade-up hero-fade-up-2", "text-center")}>
                    ...
                    {/* Quick Links */}
                    <div className={cn("hero-fade-up hero-fade-up-3", "flex items-center justify-center gap-4 sm:gap-6 mt-8 sm:mt-12")}>
